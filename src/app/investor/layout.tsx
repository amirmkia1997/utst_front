            ...
            <nav className="space-y-1">
              <div className=" bg-[#E8EBFF] rounded-lg">
                ...
                >
                  ...
                  />
                  <div>
                    <p className=" my-1 text-sm">سرمایه‌گذار</p>
              ...
              >
                <File
                  size={20}
                  weight={
                    pathname === '/investor/projects' ? 'Bold' : 'Outline'
                  }
                />
                <span>کارتابل</span>
              </Link>
              ...
              >
                <LockPassword
                  size={20}
                  weight={
                    pathname === '/investor/requests' ? 'Bold' : 'Outline'
                  }
                />
              ...
              >
                <Bell
                  size={20}
                  weight={
                    pathname === '/investor/messages' ? 'Bold' : 'Outline'
                  }
                />
                <span>پیام ها </span>
              </Link>
              ...
              >
                <Settings
                  size={20}
                  weight={
                    pathname === '/investor/settings' ? 'Bold' : 'Outline'
                  }
                />
                <span>تنظیمات</span>
              </Link>
              <Link
                href="/investor/profile-preview"
                className={`flex items-center gap-2 space-x-3 p-3 rounded-lg hover:bg-gray-50 ${
                  pathname === '/investor/profile-preview'
                    ? 'bg-[#E8EBFF] text-[#1B36FF]'
                    : 'text-gray-700'
                }`}
              >
              ...
              <Link
                href="/investor/add-account"
                className={`flex items-center gap-2 space-x-3 p-3 rounded-lg hover:bg-gray-50 ${
                  pathname === '/investor/add-account'
                    ? 'bg-[#E8EBFF] text-[#1B36FF]'
                    : 'text-gray-700'
                }`}
              >
                <AddCircle
                  size={20}
                  weight={
                    pathname === '/investor/add-account' ? 'Bold' : 'Outline'
                  }
                />
